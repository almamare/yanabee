    ...
    const sections: SidebarSection[] = [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'التسعيرات', link: '/dashboard/packages', icon: 'far fa-money-check-edit-alt' },
                { label: 'الصناديق', link: '/dashboard/balances', icon: 'far fa-usd-square' },
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'الاعدادات', link: '/dashboard/settings', icon: 'far fa-cog' },
                { label: 'التعليمات', link: '/dashboard/tutorials', icon: 'far fa-question-square' },
            ],
        },
    ];
