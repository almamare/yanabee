    ...
    return (
        <>
            ...
            <div className="flex items-center justify-end mb-4">
                <label htmlFor="roleSelect" className="mr-2 text-md font-medium text-gray-700">
                    الفرز حسب الدور:
                </label>
                <select
                    id="roleSelect"
                    ...
                    {statusTabs.map(tab => (
                        <li key={tab.id} className="me-2">
                            <button
                                ...
                                className={`inline-block px-4 py-2 border-b-2 rounded-t-lg font-bold transition-colors duration-300 ${activeStatus === tab.value
